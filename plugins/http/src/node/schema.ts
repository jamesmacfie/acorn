...
export const httpRequests = sqliteTable(
  ...
  (t) => [
    index('http_requests_user_project_folder_idx').on(t.userId, t.projectId, t.folder),
...
export const httpVariables = sqliteTable(
  ...
  (t) => [uniqueIndex('http_variables_user_project_name_idx').on(t.userId, t.projectId, t.name)],
)
