...
// An empty field is stored empty rather than sealed (docs/http-client.md § Data model). Nothing
// distinguishes a sealed empty string from a value this node cannot decrypt, so rows sealed by
// earlier code stay unreadable.
const EMPTY = ''
