...
import { contextInjectionEnabled, isDir, loadTask } from '@acorn/node-core/main/taskWorktree.ts'
import { buildSessionEnv } from '@acorn/node-core/main/taskEnv.ts'
import { assembleContext } from '@acorn/node-core/server/agentTools/contextSections.ts'
