...
// reason to know its shape. Nothing here references another database — project_id is a plain opaque
// string resolved through CoreServices.projects rather than joined, because a query never spans files.
...
// on (scope, project_id, name) resolve newest-updatedAt. Machine-scoped.
//
