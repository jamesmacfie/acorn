...
// reverted to false, and the first-run wizard reappeared over the work of someone who had already closed it.
//
// `opened` is module-scoped for the same reason, and is the latch described in gate.ts: the wizard creates a
// project, which is exactly the condition that opened it, so the trigger must not double as the reason to stay.
