...
// searchRoute (server/routes/search.ts), whose SearchBridge (server/search.ts) runs ripgrep against
// the task's worktree. Types live here so node + client stay in lockstep, like shared/terminal.ts.
