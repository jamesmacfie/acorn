...
describe('declared frame contributions', () => {
  ...
  it('has an empty list of every kind when the manifest declares no contributions at all', async () => {
    ...
    expect(installedPluginInfo(installed[0]).contributions)
      .toEqual({ frames: [], sources: [], slots: [], palette: [], commands: [], keybindings: [], attention: [], nodeStats: [], contentLinks: [], agentContexts: [], refResolvers: [], routes: [], themes: [], contextMenus: [], extensionPoints: [], extensions: [], collections: [], schedules: [], taskChecks: [], harnesses: [] })
  })
