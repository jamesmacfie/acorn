...
//
// Resolve checkout paths lazily. Importing server modules stays side-effect free so route and protocol
// tests can run without a desktop package directory or a filesystem walk.
