...
export function renderPluginAuthoring(vocabulary = pluginAuthoringVocabulary()): string {
  ...
  return [
    ...
    'DATA you declare and the host draws: it costs no document, looks native, and stays live when nothing',
    'of yours is mounted. A pane, a panel body or a settings page is a TREE: your bundle names the host\u2019s',
    'own components and the host draws them, so you get its keyboard handling, focus and style pack. A',
    'frame is for PIXELS the host cannot draw: a canvas, a chart, an editor. Do not reach for a frame to',
    'draw a 20px badge, and do not try to draw a pane out of descriptors.',
    '',
