...
import { z } from 'zod'
import { acknowledgeRepoConfig, repoConfigTrustReview } from '../../repoConfigTrust'
...
// implementation is core's (server/repoConfigTrust.ts), and the handle is core's `c.env.DB`. A bridge
