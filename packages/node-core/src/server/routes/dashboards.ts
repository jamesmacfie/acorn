...
// while panels rendered, with last-write-wins buckets to make several clients converge — all of it
// compensating for the wrong writer, and all of it obsoleted by the scheduler.
//
