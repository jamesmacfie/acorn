 ...
 *  (registries/collections.ts); the registry's own `id` is a host-minted convenience. */
type CollectionRef = Pick<CollectionContribution, 'pluginId' | 'collectionId' | 'name'>
...
export const viewsForCollection = (entry: Pick<CollectionContribution, 'schema'>): PanelViewKind[] =>
