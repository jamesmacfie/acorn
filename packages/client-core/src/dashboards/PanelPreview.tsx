...
// The wizard's live preview (docs/dashboards.md § The generated editor): the draft panel, drawn by
// the real view components over the real compose, mapping and shaping pipeline, in a fixed slot.
// There is exactly one way to draw a panel (views/PanelBody.tsx) and this is it, so the committed
// panel is always what you were looking at.
//
// Two things it is not, beyond what the doc already covers:
//
