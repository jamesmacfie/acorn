...
import { collectionContribution, emptyCollectionPage, type CollectionContribution } from '../../host/registries/sources/collections'
 ...
 *  (`workspaces/activeWorkspaceId.ts`), and importing that reaches `@solidjs/router`, which throws in
