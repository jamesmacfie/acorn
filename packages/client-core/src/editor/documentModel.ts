 ...
 * a value this scope does not have, such as a task-scoped route on a project pane, so the surface
 * can say so instead of fetching a URL with a literal `:taskId` in it.
 *
