...
const { agentContextRegistry } = await import('../registries/sources/agentContexts')
const { attentionRegistry } = await import('../registries/rail/attention')
const { collectionRegistry } = await import('../registries/sources/collections')
const { nodeStatRegistry } = await import('../registries/rail/nodeStats')
const { commandAvailable, commandRegistry, executeCommand } = await import('../registries/commands/commands')
const { keybindingRegistry } = await import('../registries/commands/keybindings')
const { contentLinkRegistry, parseInAppTarget } = await import('../registries/panes/contentLinks')
const { refResolverRegistry } = await import('../registries/panes/refResolvers')
...
const { _resetChromeContributions, syncChromeContributions, usableEmptyState } = await import('./chromeRegister')
