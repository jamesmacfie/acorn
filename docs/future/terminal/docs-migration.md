...
| `docs/third-party/monaco.md` | header, three body mentions, Related | Links repointed to `01-why.md`; prose that argues from the terminal is unchanged. |
...
| `docs/terminal-and-agents.md` | the PTY | 2, 6 | The PTY on the TUI; the editor handoff; docker exec. |
