...
Status: proposal, 2026-08-30. Phases 0 to 4 shipped the same day; phase 5 is next.
...
is 64 files (37 components, 15 utility modules, 11 tests) and `packages/client-core/src/host/registries/`
...
| [1: docs shape](./phase-1-docs-shape.md) — shipped | `docs/README.md` (new), `docs/conventions.md`, the `plugins.md` split, the corrected canonical plugin layout, four renames. | 0 |
| [2: apps](./phase-2-apps.md) — shipped | `apps/node` gets `entries/` and `composition/`; `apps/desktop` loses the empty `app/` level and gets `helper/` out of `shell/`. | 1 |
