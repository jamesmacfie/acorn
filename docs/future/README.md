...
| [orchestration.md](./orchestration.md) | An agent spawning and waiting on acorn's agents. | Revised 2026-09-11 around managed-session ownership. The agent tools, trusted caller context, spawn ledger, and lineage UI remain. [workflows.md](../workflows.md) owns the declarative engine. |
