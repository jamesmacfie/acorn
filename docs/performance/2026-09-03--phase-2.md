...
`ACORN_PERF=1 tauri dev` against this machine's real `<checkout>/apps/node/.acorn` data root (16 plugins, a 1.6 MB
...
machine's `<checkout>/apps/node/.acorn` directory: 16 plugins, five of them loaded from disk, a 1.6 MB `core.sqlite`,
