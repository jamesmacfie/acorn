...
import { prefsOptions, tasksKey, tasksOptions, workspacesOptions, type Task } from '../../core/client/queries'
import { archiveTask } from '../../core/client/tasks/mutations'
import { paneAvailable, paneContribution, paneContributions } from '../../core/client/registries/panes'
import { registerCommands } from '../../core/client/registries/commands'
import { registerKeybindings, resolveKeybindings, keybindingRegistry } from '../../core/client/registries/keybindings'
import { workspaceForRepo } from '../../core/client/workspaces/activeWorkspace'
import { addSession, refreshSessions, requestTerminalFocus } from '../../core/client/tasks/agentSessions'
...
import { dispatchLayout, layoutForTask, maximizedPane, setActiveTaskId, setMaximizedPane, setSelectedSource } from '../../core/client/tasks/tasks'
import { activateTaskSignals, pathForTask } from '../../core/client/tasks/activate'
import { formatChord } from '../../core/client/tasks/paneShortcuts'
import { taskStatus } from '../../core/client/tasks/taskStatus'
import TaskPaneHost from '../../core/client/tasks/TaskPaneHost'
import { confirmWillEvent } from '../../core/client/registries/willPhase'
import { TaskSlotHost } from '../../core/client/registries/uiSlots'
import { completeTaskArchive } from '../../core/client/tasks/archiveLifecycle'
import CopyButton from '../../core/client/ui/CopyButton'
import '../../core/client/tasks/task-view.css'
