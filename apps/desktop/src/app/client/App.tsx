...
import { filesKey, forceRefreshPull, meKey, meOptions, pinsOptions, prefsOptions, pullKey, pullsKey, pullsRoute, pullsPrefixKey, reposKey, reposOptions, reposRefreshRoute, tasksOptions, workspacesKey, workspacesOptions, type Pull } from '../../core/client/queries'
import { bootstrapWorkspaces } from '../../core/client/workspaces/mutations'
import RepoPicker from '../../core/client/ui/RepoPicker'
import WorkspacePicker from '../../core/client/ui/WorkspacePicker'
import { workspaceForRepo } from '../../core/client/workspaces/activeWorkspace'
import { planWorkspaceViewTransition } from '../../core/client/workspaces/workspaceViewTransition'
import PullList from '../../plugins/github/client/PullList'
import AccountMenu from '../../core/client/AccountMenu'
import { initWorkflowNotices } from '../../core/client/notifications/notifications'
import { initSessions, sessions } from '../../core/client/tasks/agentSessions'
import TabRail from '../../core/client/tabs/TabRail'
import RailTips from '../../core/client/tooltip/RailTips'
import { activeTaskId, focusedPane, isTerminalMax, isTerminalOpen, maximizedPane, rememberWorkspaceView, selectedSource, setMaximizedPane, setSelectedSource, setTerminalMax, setTerminalOpen, toggleFocusedPaneMax, workspaceView } from '../../core/client/tasks/tasks'
import { isTerminalTarget } from '../../core/client/lib/isTypingTarget'
...
import Acorn from '../../core/client/Acorn'
import { registerCommands } from '../../core/client/registries/commands'
import { KeybindingDispatcher, registerKeybindings } from '../../core/client/registries/keybindings'
import { confirmWillEvent, registerWillHandler, WillConfirmationHost } from '../../core/client/registries/willPhase'
import { startClientPollers } from '../../core/client/registries/pollers'
import { SlotHost, type UiSlotContext } from '../../core/client/registries/uiSlots'
import { createAppStartupRestore } from '../../core/client/persistence/appStartup'
...
const SettingsModal = lazy(() => import('../../core/client/settings/SettingsModal'))
