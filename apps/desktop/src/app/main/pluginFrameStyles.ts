...
// client-core/ui/frameTips.ts, which `mountFrame` calls for it, because the shell's singleton cannot
// see into another document. It lives apart from ui/tips.tsx so a frame bundle does not pull Solid and
// the primitives in with it.
