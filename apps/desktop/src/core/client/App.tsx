...
import { initSessions, sessions } from '../../plugins/terminal/client/sessions'
import TabRail from './tabs/TabRail'
import RailTips from './tooltip/RailTips'
import { activeTaskId, focusedPane, isTerminalMax, isTerminalOpen, maximizedPane, rememberWorkspaceView, selectedSource, setMaximizedPane, setSelectedSource, setTerminalMax, setTerminalOpen, toggleFocusedPaneMax, workspaceView } from './tasks/tasks'
