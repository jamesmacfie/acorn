...
// Run-target routes (docs/next 13 §A): the RENDERER's run surface — the run pane and preview home
...
// memory and the drivable browser moved there wholesale in Phase 4. What's left here is one bridge:
...
// Auth is enforced globally by requireUser in createApp() (docs/next/security.md §3).
