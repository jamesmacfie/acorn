...
//
// Deliberate segment doubling: a router that states its own top-level segment internally repeats it
// under its namespace. None is left in this file — workflows' `/workflows/runs/...` moved with the
