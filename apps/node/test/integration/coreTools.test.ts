...
import { localGitAgentTools } from '@acorn/plugin-changes/testkit'
import { memoryAgentTools } from '@acorn/plugin-memory/testkit'
import { runAgentTools } from '@acorn/plugin-terminal/testkit'
import { buildAgentTools } from '@acorn/node-core/server/agentTools/coreTools.ts'
import { notesAgentTools } from '@acorn/plugin-notes/testkit'
import { NotesStore } from '@acorn/plugin-notes/testkit'
import { browserAgentTools } from '@acorn/plugin-browser/testkit'
