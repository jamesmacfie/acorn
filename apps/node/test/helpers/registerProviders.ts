...
// registers its own descriptor from `init` through `ctx.providers` now, so the composition root has
// no provider list of its own any more. A suite that only wants a registered provider, to
