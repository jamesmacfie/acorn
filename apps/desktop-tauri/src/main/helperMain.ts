...
// The desktop helper process: everything Electron main owned that was already Electron-free, running
// under the bundled Node runtime with Rust as its supervisor
