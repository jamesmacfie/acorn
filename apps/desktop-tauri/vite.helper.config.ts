...
// The desktop helper process, bundled the way electron-vite bundles Electron main and for the same
// reason: @acorn/* packages ship TypeScript source, so a real Node cannot import them out of
// node_modules. Our own source goes into the bundle; every other bare specifier stays external and is
...
export default defineConfig({
  build: {
    ...
    rollupOptions: {
      external,
      input: resolve(import.meta.dirname, 'src/main/helperMain.ts'),
